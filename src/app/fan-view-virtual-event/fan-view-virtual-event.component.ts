...
@Component({
  selector: 'app-fan-view-virtual-event',
  templateUrl: './fan-view-virtual-event.component.html',
  styleUrls: ['./fan-view-virtual-event.component.scss']
})
export class FanViewVirtualEventComponent implements OnInit {
  modalRef: BsModalRef;
